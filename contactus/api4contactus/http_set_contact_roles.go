...
var setContactRoles = facade4contactus.SetContactRoles

func httpSetContactRoles(w http.ResponseWriter, r *http.Request) {
	var request dto4contactus.SetContactRolesRequest
	handler := func(ctx context.Context, userCtx facade.User) (interface{}, error) {
		return nil, setContactRoles(ctx, userCtx, request)
	}
