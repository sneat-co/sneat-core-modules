...
func (s sneatAppBotDal) CreateAppUserFromBotUser(ctx context.Context,
	...
	botUserData := facade4auth2.BotUserData{
	...
	botUser, params, err = facade4auth2.CreateBotUserAndAppUserRecords(ctx, tx, appUser.ID, bot.Platform, botUserData, remoteClientInfo)
	if err != nil {
