...
func TestRemoveMetrics(t *testing.T) {
	...
	//test := func(t *testing.T, request dto4spaceus.SpaceMetricsRequest, expected int) {
	...
	//	request := dto4spaceus.SpaceMetricsRequest{
	//		SpaceRequest: dto4spaceus.NewSpaceRequest("space1"),
	//		Metrics:     []string{"m1"},
	//	}
	//	test(t, request, 4)
	//})
