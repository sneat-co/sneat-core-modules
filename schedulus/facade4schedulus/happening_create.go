...
func createHappeningTx(ctx context.Context, tx dal.ReadwriteTransaction, request dto4schedulus.CreateHappeningRequest, happeningDto *models4schedulus.HappeningDto, params *dal4teamus.ModuleTeamWorkerParams[*models4schedulus.SchedulusTeamDto]) (
	response dto4schedulus.CreateHappeningResponse, err error,
) {
